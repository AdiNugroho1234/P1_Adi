...
class StaffController extends Controller
{
    ...
    {
        $jabatans = DB::table('t_jabatan')->orderBy('nama_jabatan')->get();
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'id_jabatan' => 'required|exists:t_jabatan,id',
    ...
    public function destroy($id)
    {
        ...
        if ($staff && $staff->avatar && file_exists(public_path('storage/' . $staff->avatar))) {
            unlink(public_path('storage/' . $staff->avatar));
        }
