...
class TujuanController extends Controller
{
    public function tujuan()
    {
        ...
        return view('tujuan.tujuan', ['data' => $data, 'tujuan' => $tujuan]);
    }
    ...
    public function show($id)
    {
        ...
        if (!$cek) {
            return redirect()->route('tujuan.tujuan')->with('error', 'Data tujuan tidak ditemukan.');
        }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('tujuan.tujuan');
    }
